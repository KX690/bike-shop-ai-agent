...
def cargar_rag():
    ...
    with st.spinner("🔄 Inicializando el asistente de la tienda..."):
...
def main() -> None:
    ...
    st.set_page_config(
        page_title="CicloStore AI - Asistente de Tienda",
        page_icon="🚴",
        layout="wide",
    ...
    st.markdown(
        """
        <h1 class="main-title">
            🚴 CicloStore AI - Asistente Inteligente
        </h1>

        <div class="subtitle">
            Productos, envíos, devoluciones, garantías y más
        </div>
        """,
    ...
    st.html(
        ...
        <div class="info-box">
            ...
            <p>
                ...
                sobre nuestro <strong>catálogo de bicicletas y accesorios</strong>,
                <strong>envíos y entregas</strong>,
                <strong>devoluciones y garantías</strong>,
                <strong>privacidad de datos</strong>
                y más información sobre nuestra tienda.
            </p>
        </div>
        """
    )
